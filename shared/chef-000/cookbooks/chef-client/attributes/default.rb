...
default["chef_client"]["ssl_verify_mode"] = nil
default["chef_client"]["ssl_client_key"] = nil # set to filename in files/default/certs
default["chef_client"]["ssl_client_cert"] = nil # set to filename in files/default/certs
default["chef_client"]["ssl_ca_file"] = nil # set to filename in files/default/certs
...
when "openbsd","freebsd","mac_os_x","mac_os_x_server"
  ...
  default["chef_client"]["enable_daemon"] = true
