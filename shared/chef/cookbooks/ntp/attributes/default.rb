...
default['ntp']['servers']   = %w{ time.rackspace.com 0.pool.ntp.org 1.pool.ntp.org 2.pool.ntp.org 3.pool.ntp.org }
...
when "freebsd"
  ...
  #added since ohai has trouble deciding if freebsd is virtualized or not. our default is yes.
  default['ntp']['virtual'] = true
end
